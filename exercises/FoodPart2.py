...
testStdinURL = "http://www.cs.princeton.edu/~cos126/docs/data/Food/naScores.txt";
testMain("3");
testStdinURL = "http://www.cs.princeton.edu/~cos126/docs/data/Food/germanScores.txt";
testMain("2");
