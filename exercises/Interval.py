...
For \verb|subsetOf|, the containment doesn't have to be strict. For example
...
testOn("tangDynasty", "subsetOf", var("alfredTheGreat"));
testOn("persianEmpire", "subsetOf", var("alfredTheGreat"));
